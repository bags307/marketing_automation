...
class Lead extends \Mautic\LeadBundle\Entity\Lead implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'availableSocialFields', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'id', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'owner', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'points', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'pointsChangeLog', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'doNotContact', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'ipAddresses', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'pushIds', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'lastActive', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'internal', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'socialCache', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'updatedFields', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'color', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'newlyCreated', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'dateIdentified', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'notes', 'fields', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'preferredProfileImage', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'wasAnonymous', 'imported', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'tags', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'stage', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'stageChangeLog', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Lead' . "\0" . 'utmtags', 'changes');
        }
    ...
    public function stageChangeLogEntry($type, $name, $action)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'stageChangeLogEntry', array($type, $name, $action));

        return parent::stageChangeLogEntry($type, $name, $action);
    }
