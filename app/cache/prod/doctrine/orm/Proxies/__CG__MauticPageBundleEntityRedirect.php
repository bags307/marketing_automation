...
class Redirect extends \Mautic\PageBundle\Entity\Redirect implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Redirect' . "\0" . 'id', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Redirect' . "\0" . 'redirectId', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Redirect' . "\0" . 'url', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Redirect' . "\0" . 'hits', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Redirect' . "\0" . 'uniqueHits', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Redirect' . "\0" . 'trackables', 'changes');
        }
