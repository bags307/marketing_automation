...
class Stage extends \Mautic\StageBundle\Entity\Stage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'id', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'name', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'description', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'weight', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'log', '' . "\0" . 'Mautic\\StageBundle\\Entity\\Stage' . "\0" . 'category', 'changes');
        }
