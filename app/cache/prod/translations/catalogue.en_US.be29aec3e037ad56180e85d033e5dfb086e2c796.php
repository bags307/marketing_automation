...
$catalogue = new MessageCatalogue('en_US', array (
  ...
  array (
    ...
    'mautic.dynamicContent.form.confirmbatchdelete' => 'Delete the selected items?',
    'mautic.dynamicContent.form.confirmdelete' => 'Delete the dynamic content item, %name%?',
    ...
    'mautic.dynamicContent.form.variantParent' => 'Variant Parent',
    'mautic.dynamicContent.form.variantParent.help' => 'If this is a top level item, leave blank. If this is a variant of a top level item, select it below.',
    'mautic.dynamicContent.form.variantParent.empty' => 'This is a top level item.',
    'mautic.dynamicContent.header.edit' => 'Edit Dynamic Content - %name%',
    'mautic.dynamicContent.header.editvariant' => 'Variant of %parent%',
    'mautic.dynamicContent.header.new' => 'New Dynamic Content',
    'mautic.dynamicContent.help.searchcommands' => '<strong>Search commands</strong><br />is:published<br />is:unpublished<br />is:mine<br />is:uncategorized<br />category:{category alias}<br />lang:{lang code}',
    'mautic.dynamicContent.menu.edit' => 'Edit Page',
    'mautic.dynamicContent.menu.view' => 'View Page',
    'mautic.dynamicContent.icon_tooltip.variants' => 'Has Variants',
    ...
    'mautic.dynamicContent.report.variant_parent_id' => 'Default Content ID',
    'mautic.dynamicContent.report.variant_parent_title' => 'Default Content Title',
    'mautic.dynamicContent.variants' => 'Variants',
    'mautic.core.form.addvariant' => 'Add Variant',
    ...
    'mautic.dynamicContent.no.dynamicContent.note' => 'Please create a dynamic content item to select.',
    ...
    'mautic.email.timeline.event.list' => 'Email was sent to this Contact because he/she belongs to \'%list%\' Segments.',
    ...
    'mautic.email.icon_tooltip.list_email' => 'Is a segment (mass send) email',
    ...
    'mautic.form.type.campaign.description' => 'Campaign forms can be selected to be the source of contacts when building a campaign. All the actions for a form submission will be controlled by the campaign builder.',
    ...
    'mautic.lead.batch.campaigns' => 'Batch edit the selected contacts\' campaigns.',
    'mautic.lead.batch.dnc' => 'Set selected contacts as Do Not Contact.',
    'mautic.lead.batch.dnc_reason' => 'Reason',
    'mautic.lead.batch.lists' => 'Batch edit the selected contacts\' segments.',
    'mautic.lead.batch.remove_from' => 'Remove from the following:',
    'mautic.lead.batch.stages' => 'Set to the selected stage',
    ...
    'mautic.lead.field.type.region' => 'Segment - Region',
    ...
    'mautic.lead.field.type.timezone' => 'Segment - Timezone',
    ...
    'mautic.lead.lead.help.searchcommands' => '<strong>Search commands</strong><br />is:anonymous<br />is:unowned<br />is:mine<br />email:*<br />segment:{segment alias}<br />name:*<br />company:*<br />owner:*<br />ip:*',
    ...
    'mautic.lead.list.filter.lead_email_received' => 'Email Received',
    ...
    'mautic.widget.lead.lifetime' => 'Lifetime cycle',
    ...
    'mautic.notification.form.action.sendnotification.lead' => 'Send web notification to lead',
    'mautic.notification.form.action.sendnotification.lead.descr' => 'Send the web selected notification to the lead upon form submission.',
    ...
    'mautic.notification.form.list' => 'Lead list',
    ...
    'mautic.notification.type.list.description' => 'A list notification can be manually sent to selected lead lists. Once the notification has been sent, it cannot be edited. However, it can be sent to new leads as they are added to the associated lists.',
    ...
    'mautic.notification.type.template.description' => 'A template notification is automatically sent by campaigns, forms, point triggers, etc. These can be edited but cannot be sent to a lead list.',
    ...
    'mautic.notification.thead.stats' => 'Stats',
    'mautic.notification.no.notifications.note' => 'Please create a Notification to select',
    ...
    'mautic.notification.campaign.failed.not_contactable' => 'Lead is not contactable on the Web Notification channel.',
    'mautic.notification.campaign.failed.not_subscribed' => 'The lead has not subscribed to the Web Notification channel.',
    ...
    'mautic.plugin.command.fetch.leads' => 'Command to fetch leads from integration',
    'mautic.plugin.command.fetch.leads.starting' => 'Fetch leads command is starting',
    'mautic.plugin.command.fetch.leads.events_executed' => 'Number of leads fetched: %events%',
    ...
    'mautic.plugin.integration.tab.fieldmapping' => 'Contact Field Mapping',
    ...
    'mautic.integration.form.feature.get_leads' => 'Pull leads from integration',
    ...
    'mautic.sms.form.action.sendsms.lead' => 'Send sms to lead',
    'mautic.sms.form.action.sendsms.lead.descr' => 'Send the selected sms to the lead upon form submission.',
    ...
    'mautic.sms.form.list' => 'Lead list',
    'mautic.sms.header.edit' => 'Edit Notifiation - %name%',
    ...
    'mautic.sms.type.list.description' => 'A list sms can be manually sent to selected lead lists. Once the sms has been sent, it cannot be edited. However, it can be sent to new leads as they are added to the associated lists.',
    'mautic.sms.type.template' => 'Template Text Messages',
    'mautic.sms.type.template.header' => 'New Template Text Message',
    'mautic.sms.type.template.description' => 'A template sms is automatically sent by campaigns, forms, point triggers, etc. These can be edited but cannot be sent to a lead list.',
    ...
    'mautic.sms.campaign.failed.not_contactable' => 'Lead is not contactable on the SMS channel.',
    'mautic.sms.campaign.failed.missing_number' => 'Missing phone number for lead.',
    ...
    'mautic.stage.choose.stage_descr' => 'Select stage that will be assigned to leads in this campaign',
  ...
  array (
    ...
    'mautic.core.variant_weights_invalid' => 'The sum of traffic weights between all variants cannot be more than 100%',
